# inspired by: https://blog.theodo.fr/2018/05/why-you-need-a-makefile-on-your-project/
...
## —— NPM —————————————————————————————————————————————————————————————————
npm-install: ## Install npm packages by package-lock.json
	$(NPM) install
...
## —— Project ——————————————————————————————————————————————————————————————————
instali-project: ## Install new project after clone repozitory
	make install
	make npm-install
	make load-fixtures
	make assets
...
## —— Deploy ——————————————————————————————————————————————————————————————————
deploy: ## Deploy, install composer dependencies and run database migrations. For running this command you have tu create file bin/prod/deploy.sh
	bin/prod/deploy.sh
